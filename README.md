...
- **customize-dds** — Customize the CycloneDDS middleware configuration for single-computer or dual-computer setups: decides whether MoveIt Pro manages the DDS config (`USE_HOST_DDS`) and writes the cross-PC `CYCLONEDDS_*` environment variables.
